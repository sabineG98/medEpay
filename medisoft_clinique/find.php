...
<!--<table width="0" bgcolor="#CCCCCC" border="0" cellspacing="0" cellpadding="0">
 <form action="find.php" method="post">
  <tr>
    <td><input  type="text" placeholder="Insurance code, name," style="border: 1px solid #069;  height:30px; padding-left:30px;  font-size:16px;" autocomplete="off" name="client" size="30" /></td>
    <td>
    </td>
...
<form action="find.php" method="post">
<input  type="text" id="search-box" placeholder="Insurance code, name," style="border: 1px solid #069;  height:30px; padding-left:30px;  font-size:16px;" autocomplete="off" name="client" size="30" />
