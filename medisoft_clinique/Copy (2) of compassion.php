...
<div class="content">
<div style="width: 231px; height: 24px; position: absolute; background-color: #F00; border-radius: 10px 10px 0px 0px; left: 372px; top: 29px;"> &nbsp;&nbsp;<b>COMPASSION</b>
  <div style="background-color:#C2E7FC; border: 1px solid #09F; box-shadow: 0px 0px 5px 0px #000; border-radius: 5px 5px 5px 5px; width:591px; height:237px; position:absolute; left: -360px; top: 23px;">
...
<table>
 <tr>
   ...
   <tr>
     <td>Code</td><td><input type="text" size="15" placeholder="" name="insurance_code" /></td>
   </tr>
   <tr>
  ...
  <input type="hidden" name="insurance" value="COMPASSION" /><button class="button" ><span>Ajouter</span></button>
  </td>
  </tr>
