...
<table>
 <tr>
   ...
   <!--<input type="radio" checked="checked" name="area" value="Z" /><strong>Z</strong>
   <input type="radio" name="area" value="Z" /><strong>HZ</strong>
   <input type="radio" name="area" value="Z" /><strong>HD</strong>-->
   </tr>
   <tr>
