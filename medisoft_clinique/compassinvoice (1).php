...
<table style="font-size:13px;" widtd ="0" border="1" cellspacing="0" cellpadding="0">
  <tr>
  <th  bgcolor="#CCCCCC" style=" text-transform:uppercase;" colspan="17">Relevé des Factures compassion<?php echo '/mois- '.$facmonth.'-'.$facyear ?></th>
  </tr>
  ...
  $med = "SELECT DISTINCT date FROM orders ORDER BY date ASC";// get the date 
   ...
   $facture1 = "SELECT DISTINCT client_id, date FROM orders WHERE period='$period' AND date='$dat' ";
											 ...
											 $facture2 = "SELECT* FROM clients WHERE client_id=$cid AND insurance='COMPASSION'";
