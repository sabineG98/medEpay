...
$section = "SELECT  SUM( amountde) AS de FROM verification WHERE client_id=$cid AND  period='$period'";// get the zone numbers
        $retval = mysqli_query($link, $section);
        if(! $retval )
           {
               die('Could not get data: ' . mysqli_error($link));
