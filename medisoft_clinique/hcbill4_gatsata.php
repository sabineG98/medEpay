...
<table style="font-size:13px;" widtd ="0" border="1" cellspacing="0" cellpadding="0">
  <tr>
  <th  bgcolor="#CCCCCC" style=" text-transform:uppercase; height:40px; font-size:16px;" colspan="19">PS GATSATA-S U M M A R Y   OF  V OUC H E R S    F O R   R W A N D A  S O C I A L  S E C U R I T Y  B O A D (R S S B) / CBHI/  <?php echo ''.$facmonth.'-'.$facyear ?></th>
  </tr>
