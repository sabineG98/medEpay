...
mysqli_query ($link,"INSERT INTO products (description, type, unit_price, date) 
                               VALUES ('$item', '$type', '$unityp', '$date')");
...
<form action="tarifconso.php">
<input type="submit" value="CONSOMMABLES" />
</form>
