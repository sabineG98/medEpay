...
<div id="tab-container" class='tab-container'>
 ...
 <div class='panel-container'>
     ...
     <div id="cons">
     <iframe style="position:absolute; border: 0px solid #F00; width: 1200px; height: 320px;" src="vital.php?id=<?php echo $id; ?>&insu=<?php echo $insu; ?>&date=<?php echo $date; ?>"></iframe>
   ...
   <div id="lab">
     <iframe style="position:absolute; border: 0px solid #F00; width: 1200px; height: 320px;" src="sympto.php?id=<?php echo $id; ?>&insu=<?php echo $insu; ?>&date=<?php echo $date; ?>"></iframe>
...
-->
  ...
  <div id="med">
     ...
     <iframe style="position:absolute;  border: 0px solid #F00; width: 1000px; height: 320px;" src="lab.php?id=<?php echo $id; ?>&insu=<?php echo $insu; ?>&date=<?php echo $date; ?>">
     </iframe>
...
-->
  ...
  <div id="conso">
     <iframe style="position:absolute; border: 0px solid #F00; width: 1000px; height: 320px;" src="diag.php?id=<?php echo $id; ?>&insu=<?php echo $insu; ?>&date=<?php echo $date; ?>"></iframe>
...
-->
  ...
  <div id="act">
    <iframe style="position:absolute; border: 0px solid #F00; width: 1000px; height: 320px;" src="actes.php?id=<?php echo $id; ?>&insu=<?php echo $insu; ?>&date=<?php echo $date; ?>"></iframe>
...
-->
  ...
  <div id="hosp">
     <iframe style="position:absolute; border: 0px solid #F00; width: 1200px; height: 320px;" src="presc.php?id=<?php echo $id; ?>&insu=<?php echo $insu; ?>&date=<?php echo $date; ?>"></iframe>
