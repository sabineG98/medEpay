...
<head>
  ...
  <style> 
    ...
    .panel-container { margin-bottom: 10px; height:530px;  }
  </style>
...
<div id="tab-container" class='tab-container'>
  <ul class='etabs'>
   ...
   <li class='tab'><a href="#lab"><strong>CONSUMABLES</strong></a></li> -->
   <li class='tab'><a href="#med"><strong>MEDICAL ACTS - Tarification by Minisante</strong></a></li>
 </ul>
 <div class='panel-container'>
    <!-- <div id="cons">
     <iframe style="border: 0px solid #F00; width: 100%; height: 100%;" src="tarifxy.php"></iframe>     
    </div>    
    
    <div id="lab">
     <iframe style="border: 0px solid #F00; width: 100%; height: 100%;" src="tarif-consox.php"></iframe>
  	</div> -->
      
  	<div id="med">
     <iframe style="border: 0px solid #F00; width: 100%; height: 100%;" src="tarif-actsx.php"></iframe>
	</div>
