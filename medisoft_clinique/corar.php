...
<div class="content">
<div style="width:231px; height:24px; position:absolute; background-color:#F00;border-radius: 10px 10px 0px 0px; left: 524px; top: 111px;"> &nbsp;&nbsp;<b>CORAR</b>
<div style="background-color:#C2E7FC; border: 1px solid #09F; box-shadow: 0px 0px 5px 0px #000; border-radius: 5px 5px 5px 5px; width:591px; height:252px; position:absolute; left: -360px; top: 23px;">
...
<table>
   ...
   <tr>
   <td>N<sup><u>o</u></sup>. de feuille</td>
   <td><input type="text" size="10" placeholder="" name="serie" /></td>
   </tr>
   <tr>
   <td>N<sup><u>o</u></sup>. Police</td>
   <td><input type="text" size="15" placeholder="" name="police" /></td>
   </tr>
   <tr>
   <td>N<sup><u>o</u></sup>. Carte d'assuré</td><td><input type="text" size="15" placeholder="" name="insurance_code" /></td>
   </tr>
   <tr>
   <td>Noms du malade</td><td><input type="text" size="40" placeholder="" name="beneficiary" /></td>
   </tr>
   <tr>
   ...
   <tr>
   <td>Sexe</td><td><select name="sex"><option value="F"></option><option value="">Female</option><option value="M">Male</option></select></td>
   </tr>
  <tr>
  <td></td>
  <td>
  <input type="hidden" name="insurance" value="CORAR" />
