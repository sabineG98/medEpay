...
<div id="tab-container" class='tab-container'>
  <ul class='etabs'>
   <li class='tab'><a href="#cons"><strong>ENTREES GLOBALES</strong></a></li>
   <li class='tab'><a href="#lab"><strong>ENTREES ENCAISSEES</strong></a></li>
   <li class='tab'><a href="#med"><strong>DETTES(ASSURANCES)</strong></a></li>
   <li class='tab'><a href="#conso"><strong>ENTREES/UTILISATEURS</strong></a></li>

 </ul>
 <div class='panel-container'>
     <div id="cons">
     <iframe style="position:absolute; border: 0px solid #F00; width: 888px; height: 500px;" src="global.php"></iframe>
   ...
   <div id="lab">
     <iframe style="position:absolute; border: 0px solid #F00; width: 888px; height: 500px;" src="cashed.php"></iframe>
  </div>
  
  
  
  <div id="med">
     <iframe style="position:absolute; border: 0px solid #F00; width: 888px; height: 500px;" src="mustpay.php"></iframe>

  </div>
  
  <div id="conso">
     <iframe style="position:absolute; border: 0px solid #F00; width: 888px; height: 500px;" src="users.php"></iframe>
