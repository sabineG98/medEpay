                                                 ...
                                                 while($rowfac2 = mysqli_fetch_array($retvalfac2, MYSQLI_ASSOC))
                                                        {
														   ...
														   //where they were
                                                                  ...
                                                                  $facture = "SELECT DISTINCT * FROM orders WHERE client_id=$code AND date='$dat' AND  period='$period'";
                                                                       ...
                                                                       if(! $retvalfac )
                                                                            ...
                                                                            while($rowfac = mysqli_fetch_array($retvalfac, MYSQLI_ASSOC))
																					...
																					if ($rowfac['type']=='TM'&& $rowfac['insured']==0)	
															                              {
																							  
																                            $moderateur=$rowfac['unityp'];  
																                            $tmoderateur+=$moderateur; 
