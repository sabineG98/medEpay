...
<table>
   ...
   <td>
    ...
    <input type="text" id="search-box" size="100" autocomplete="off" name="product" placeholder="ACTES" />
...
<div id="suggesstion-box"></div>
     ...
     <td>
     <input type="text" style="height:17px;" size="3" placeholder='Qtté' name="qtty" /></td>
