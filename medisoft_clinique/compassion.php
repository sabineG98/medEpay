...
<div class="content">
<div style="width: 231px; height: 24px; position: absolute; background-color: #F00; border-radius: 10px 10px 0px 0px; left: 546px; top: 27px;"> &nbsp;&nbsp;<b>COMPASSION- MUSA</b>
...
<table>
 <tr>
   ...
   <td>District(MUSA)</td><td>
	...
	echo'<option  value="">Ngoma</option>';
  ...
  <input type="hidden" name="insurance" value="MUSA" />
   <input type="hidden" name="adherent" value="COMPASSION" />
