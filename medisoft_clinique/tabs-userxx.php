...
<div id="tab-container" class='tab-container'>
  <ul class='etabs'>
   <li class='tab'><a href="#cons"><strong>NOUVEAU</strong></a></li>
   <li class='tab'><a href="#lab"><strong>EXISTANTS</strong></a></li>
   <li class='tab'><a href="#ver"><strong>VERIFICATION ACCESS</strong></a></li>
 </ul>
 <div class='panel-container'>
     <div id="cons">     
     <iframe style="position:absolute; border: 0px solid #F00; width: 888px; height: 2200px;" src="adduser.php"></iframe>     
    </div>
    
   <div id="lab">
     <iframe style="position:absolute; border: 0px solid #F00; width: 888px; height: 2200px;" src="usermanager.php"></iframe>
  </div>  
  
   <div id="ver">
     <iframe style="position:absolute; border: 0px solid #F00; width: 888px; height: 2200px;" src="veraccess.php"></iframe>
  </div>
