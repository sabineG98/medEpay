...
<div class="content">
<div style="width: 231px; height: 24px; position: absolute; background-color: #F00; border-radius: 10px 10px 0px 0px; left: 371px; top: 28px;"> &nbsp;&nbsp;<b>PRIVE-Sans assurance</b>
...
<table>
 <tr>
   ...
   <tr>
      <input type="hidden" name="insurance_code" value="PRIVE" />
  ...
  <input type="hidden" name="insurance" value="PRIVE" /><button class="button" ><span>Ajouter</span></button>
  </td>
  </tr>
