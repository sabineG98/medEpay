...
<div  style=" box-shadow: 0px 0px 0px 0px #000; border: 1px solid #09F; position:absolute; background-color:green; left: 4px; top: 50px;">
...
//find the month
$facture = "SELECT DISTINCT period FROM orders WHERE verified=1 ORDER BY date DESC LIMIT 5";
                                               ...
                                               die('Could not get data: ' . mysqli_error($link));
                                                 ...
                                                 while($rowfac1 = mysqli_fetch_array($retvalfac1, MYSQLI_ASSOC))
														...
														//$_SESSION['cbhiperiod']=$period;
														 ...
														 <a href="redress.php?p='.$period.'">'.$tmusa.'</a>
