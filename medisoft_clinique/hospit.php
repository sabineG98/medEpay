...
<table style="font-size:13px;" widtd ="0" border="1" cellspacing="0" cellpadding="0">
  <tr>
  <th style="text-transform:uppercase;" bgcolor="#CCCCCC" colspan="13">LISTE DES ACCOUCHEUSES-<?php echo $period; ?></th>
  </tr>
  ...
  $i=0;
   ...
   $facture1 = "SELECT DISTINCT client_id FROM orders WHERE period='$period' ";
											 ...
											 $facture2 = "SELECT* FROM clients,orders WHERE clients.client_id=orders.client_id AND clients.client_id=$cid AND item LIKE 'Acc%' AND period='$period'  ";
