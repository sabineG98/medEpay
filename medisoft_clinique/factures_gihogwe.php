...
<div  style=" box-shadow: 0px 0px 5px 0px #000; border: 1px solid #09F; position:absolute; background-color:#FFF; left: 4px; top: 35px;">
<div style="position:absolute; border-radius: 0px 200px 10px 10px;  width:400px; border: 1px solid #09F; height:25px; background-color:#BDF; left: 1px; top: -27px;"><b>TOUTES LES FACTURES</b>---Categorized</div>
                                               ...
                                               die('Could not get data: ' . mysqli_error($link));
                                                 ...
                                                 while($rowfac1 = mysqli_fetch_array($retvalfac1, MYSQLI_ASSOC))
														...
														echo'<td rowspan="">
														 ...
														 (TM:'.$tm.')
														 <br>
														 - <a href="hcbill4_gihogwe.php?p='.$period.'">Gihogwe</a>
														 <br>
														 - <a href="hcbill4_gatsata.php?p='.$period.'">Gatsata</a>
														</td>';
