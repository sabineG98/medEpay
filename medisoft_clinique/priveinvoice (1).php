...
<table style="font-size:13px; border-collapse: collapse;" widtd ="0" border="1" cellspacing="0" cellpadding="0">
  <tr>
  <th  bgcolor="#CCCCCC" style=" text-transform:uppercase;" colspan="17">Relevé des Factures des indigents<?php echo '/mois- '.$facmonth.'-'.$facyear ?></th>
  </tr>
  ...
  $i=0;
   ...
   $facture1 = "SELECT DISTINCT client_id, date FROM orders WHERE period='$period' AND date='$dat' ";
											 ...
											 $facture2 = "SELECT* FROM clients WHERE client_id=$cid AND insurance='PRIVE'";
                                                 ...
                                                 while($rowfac2 = mysqli_fetch_array($retvalfac2, MYSQLI_ASSOC))
                                                        {
														   ...
														   echo'<td>'.$rowfac2['beneficiary'].'</td>';
                                                                  ...
                                                                  $facture = "SELECT DISTINCT * FROM orders WHERE client_id=$code AND period='$period' AND date='$dat'";
																...
																echo'<td>';
																       $facture = "SELECT DISTINCT * FROM orders WHERE client_id=$code AND period='$period' AND type='consultation' AND date='$dat'";
                                                                       $retvalfac = mysqli_query($link, $facture);
                                                                       if(! $retvalfac )
                                                                                {
                                                                            die('Could not get data: ' . mysqli_error($link));
																...
																echo'<td>';
																       $facture = "SELECT DISTINCT * FROM orders WHERE client_id=$code AND period='$period' AND type='laboratoire' AND date='$dat'";
                                                                       $retvalfac = mysqli_query($link, $facture);
                                                                       if(! $retvalfac )
                                                                                {
                                                                            die('Could not get data: ' . mysqli_error($link));
																...
																echo'<td>';
																       $facture = "SELECT DISTINCT * FROM orders WHERE client_id=$code AND period='$period' AND type='hospitalisation' AND date='$dat'";
                                                                       $retvalfac = mysqli_query($link, $facture);
                                                                       if(! $retvalfac )
                                                                                {
                                                                            die('Could not get data: ' . mysqli_error($link));
																...
																echo'<td>';
																       $facture = "SELECT DISTINCT * FROM orders WHERE client_id=$code AND period='$period' AND type='soins' AND date='$dat'";
                                                                       $retvalfac = mysqli_query($link, $facture);
                                                                       if(! $retvalfac )
                                                                                {
                                                                            die('Could not get data: ' . mysqli_error($link));
																...
																echo'<td>';
																       $facture = "SELECT DISTINCT * FROM orders WHERE client_id=$code AND period='$period' AND type='consommable' AND date='$dat'";
                                                                       $retvalfac = mysqli_query($link, $facture);
                                                                       if(! $retvalfac )
                                                                                {
                                                                            die('Could not get data: ' . mysqli_error($link));
																...
																echo'<td>';
																       $facture = "SELECT DISTINCT * FROM orders WHERE client_id=$code AND period='$period' AND type='med' AND date='$dat'";
                                                                       $retvalfac = mysqli_query($link, $facture);
                                                                       if(! $retvalfac )
                                                                                {
                                                                            die('Could not get data: ' . mysqli_error($link));
