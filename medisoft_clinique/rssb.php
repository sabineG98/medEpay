...
<strong>RWANDA SOCIAL SECURITY BOARD<br>
       (RSSB)
       
       <img style="position: absolute; left: 629px; top: 3px; width: 143px; height: 85px;" src="img/rssb.PNG" width="199" height="131"></strong>

<br><br>
<table>
  
  <tr>
   <td align="right">N<sup><u>o</u></sup>. D'AFFILIATION</td><td><input type="text" size="15" placeholder="" name="affiliation" /></td>
   </tr>
   <tr>
   
   <tr>
   <td align="right">N<sup><u>o</u></sup>. MATRICULE</td><td><input type="text" size="15" placeholder="" name="matricule" /></td>
   </tr>
   <tr>
