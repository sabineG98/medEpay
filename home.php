...
<table>
 <tr>
   ...
   <tr>
   <td align="right"><strong>CREDIT CARD</td></strong><td><input autocomplete="off" type="text" size="50" value="<?php echo $credit ?>" placeholder="" name="credit" /></td>
   </tr>  
   <tr>
   <td align="right"><strong>CVC</td></strong><td><input autocomplete="off" type="text" size="50" value="<?php echo $cvc ?>" placeholder="" name="cvc" /></td>
   </tr>
   <tr>
   <td align="right"><strong>EXP DATE</td><td></strong>
   <input type="date" style="width:436px;" name="exp" value="<?php echo $exp; ?>"/>
   </td>
   </tr>  
   <tr>
